...
cp -p $BASE/monitor-starter/gwenterprise.gif $BASE/monitor-framework/core/src/bin/portal-core-war/images
sed -i 's/GroundWork Monitor Enterprise 6.0.1/GroundWork Monitor Starter 6.0.1/' $BASE/monitor-framework/core/src/resources/portal-server-war/login.jsp

http://archive.groundworkopensource.com/groundwork-opensource/trunk/monitor-framework/core/src/bin/portal-core-war/images/gwenterprise.gif
http://archive.groundworkopensource.com/groundwork-opensource/trunk/monitor-framework/core/src/resources/portal-server-war/login.jsp
...
# WE HAVE TO MODIFY THIS! It is not updated since August
...
ssh root@morat mv -f $MoratDir/builds/BitRock/6.0/groundworkgdk-6.0.1-*-linux-$bitrock_os-installer.bin /DailyBuilds/BitRock/$qasubdir
