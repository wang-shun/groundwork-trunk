...
PRO_ARCHIVE=http://geneva/groundwork-professional/$PRO_ARCHIVE_BRANCH
           ...
           WEATHERMAP_SVN_BASE=$PRO_ARCHIVE/monitor-core/cacti/postgresql/weathermap
WEATHERMAP_GROUNDWORK_SVN_BASE=$PRO_ARCHIVE/monitor-nms/weathermap/weathermap-0.97a
