...
/bin/chmod -R uog-x $prefix/tools/system_setup/*
/bin/chmod uog+x $prefix/tools/system_setup/*.py
/bin/chmod -R uog+x $prefix/tools/system_setup/scripts/*
/bin/chmod uog+x $prefix/tools/system_setup/templates
...
# Licenses should only be readable
/bin/chmod 444 $prefix/licenses/*
