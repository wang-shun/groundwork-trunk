...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfOS_Processor -prop PercentUserTime -inst ""*"" -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfOS_Processor -prop PercentUserTime -inst ""Name = '0'"" -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "
		wscript.echo str
...
'*************************************************************************************************
		...
		strCommandName="check_100nsec_timer.vbs"
		strDescription="Check WMI counters of type PERF_100NSEC_TIMER (542180608)."
		strVersion="1.4"
