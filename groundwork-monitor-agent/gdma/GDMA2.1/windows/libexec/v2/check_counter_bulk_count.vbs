...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&"-inst instancename          Needed Instance, can be * for all"&vbCrlF
		...
		str=str&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfOS_System -prop FileControlBytesPerSec -inst ""*"" -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "
		wscript.echo str
...
'*************************************************************************************************
		...
		strDescription="Check WMI counters of type PERF_COUNTER_BULK_COUNT (272696576)."
		strVersion="1.5"
