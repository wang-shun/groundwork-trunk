...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfProc_Process -prop WorkingSet -inst ""*""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfProc_Process -prop WorkingSet -inst ""IDProcess = '3612', IDProcess = '2156'""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "
		wscript.echo str
...
'*************************************************************************************************
		...
		strCommandName="check_counter_large_rawcount.vbs"
		strDescription="Check WMI counters of type PERF_COUNTER_LARGE_RAWCOUNT (65792)."
		strVersion="1.4"
