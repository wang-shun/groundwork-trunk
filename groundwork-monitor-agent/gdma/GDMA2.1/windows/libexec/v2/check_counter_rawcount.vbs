...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfProc_Process -prop HandleCount -inst ""*""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "&vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -class Win32_PerfRawData_PerfProc_Process -prop HandleCount -inst ""IDProcess = '3612', IDProcess = '2156'""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] "
		wscript.echo str
...
'*************************************************************************************************
		...
		strDescription="Check WMI counters of type PERF_COUNTER_RAWCOUNT (65536)."
		strVersion="1.5"
