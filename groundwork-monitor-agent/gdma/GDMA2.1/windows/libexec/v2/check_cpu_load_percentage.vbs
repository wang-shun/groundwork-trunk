...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&"-t thresold pairs           Threshold pairs for each processor. Note: each thresold pair separated by a ':', warning and critical values separated by ',' character"&vbCrlF
		...
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -inst ""CPU0, _Total""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] " &vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -inst ""CPU0, _Total""  -t ""70,90:60,80"" [-user Ser1\Administrator -pass password -domain ITSP] " &vbCrlF
		wscript.echo str
...
'*************************************************************************************************
		...
		strDescription="Checks CPU load percentage using WMI."
		strVersion="1.4"
