...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&"cscript "&strCommandName&" -h hostname -inst DeviceID [-w warning_level -c critical_level] [-t thresoldpairs] [-user username -pass password [-domain domain]]"&vbCrlF
		str=str&vbCrlF
		...
		str=str&"-t thresold pairs           Threshold pairs for each instance. Note: each thresold pair is separated by a ':', warning and critical values separated by ',' character"&vbCrlF
		...
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -inst ""C:, D:""  -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP] " &vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -inst ""C:, D:""  -t ""70,90:50,80"" [-user Ser1\Administrator -pass password -domain ITSP] " &vbCrlF
		wscript.echo str
...
'*************************************************************************************************
		...
		strDescription="Checks logical disk usage using WMI."
		strVersion="1.4"
