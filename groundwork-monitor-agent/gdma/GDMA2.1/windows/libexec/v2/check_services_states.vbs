...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		str=str&"cscript "&strCommandName&" -h hostname -inst instance [-user username -pass password [-domain domain]]"&vbCrlF
		str=str&vbCrlF
		...
		str=str&vbCrlF
		str=str&"Note: instance can be one or multiple services, or *." & vbCrlF
		str=str&"If getting multiple services, the instances must be enclosed in double quotes and separated by commas." & vbCrlF
		str=str&"Example: cscript "&strCommandName&" -h Ser1 -inst ""WINS,wmi"" [-user SER1\Administrator -pass password] " & vbCrlF
		wscript.echo str
...
'*************************************************************************************************
		...
		strDescription="Check state of one or more services using WMI."
		strVersion="1.4"
