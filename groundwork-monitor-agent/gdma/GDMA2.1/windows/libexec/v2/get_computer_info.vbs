...
'-------------------------------------------------------------------------------------------------
	Function f_Help()
		...
		strHelp=strHelp&strDescription&"  If your Local Machine has the same Administrator account and password as the Remote Machine then you don't have to use the two (or three) last parameters."&vbCrlF&vbCrlF
  		...
  		strHelp=strHelp & "If getting multiple specific types of infomation, the information must be enclosed in multiple quotes and separate by commas." & vbCrlF
...
'*************************************************************************************************
		...
		strDescription="Retrieves information about various OS and hardware components using WMI."
		strVersion="1.4"
		...
		strArgDetailDes(2)=		"The desired information"
