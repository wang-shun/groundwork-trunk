...
Usage:
	...
	exch_mailbox_assistant -warning <warning value> -critical <critical value> -waittime <wait time secs> -verbose -help
  
	This plugin checks the processor time for the Mailbox assistant service.
...
$p1 = getCounter "Process" "% Processor Time" "MSExchangeMailboxAssistants"
$p2 = getCounter "Process" "% Processor Time" "MSExchangeMailboxAssistants"
$p3 = getCounter "Process" "% Processor Time" "MSExchangeMailboxAssistants"
...
$status_msg = "The Mailbox Assistants are taking up $p percent of CPU"

$perfdata_msg = "mb_assist_cpu=$p;$warning;$critical;0;100"
