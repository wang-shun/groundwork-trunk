...
Usage:
	...
	exch_message_user -warning <warning value> -critical <critical value> -waittime <wait time secs> -verbose -help
  
	This plugin checks Messages Delivered and User Count to which thresholds apply.
...
$m = getCounter "MSExchangeIS Mailbox" "Messages Delivered/sec" "_Total"
$u = getCounter "MSExchangeIS" "User Count"
	
# Check thresholds for user count
$state = setState $u $warning $critical
	
$status_msg = "There are $u users on the system, and there are $m messages per seconds being delivered to all recipients."

$perfdata_msg = "users=$u;$warning;$critical;; messages=$m;;;;"
