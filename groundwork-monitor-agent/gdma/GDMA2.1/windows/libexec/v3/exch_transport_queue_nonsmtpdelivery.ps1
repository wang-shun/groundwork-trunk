...
$m = getCounter "MSExchangeTransport Queues" "Active Non-Smtp Delivery Queue Length" "_total"
	
# Check thresholds for user count
$state = setState $m $warning $critical

$status_msg = "Non-Smtp delivery queue length is $m"

$perfdata_msg = "Active_NonSMTP=$m;$warning;$critical;;"
