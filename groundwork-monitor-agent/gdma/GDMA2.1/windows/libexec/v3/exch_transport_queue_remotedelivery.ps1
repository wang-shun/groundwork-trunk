...
$m = getCounter "MSExchangeTransport Queues" "Active Remote Delivery Queue Length" "_total"
	
# Check thresholds for user count
$state = setState $m $warning $critical
	
$status_msg = "Active remote delivery queue length is $m"

$perfdata_msg = "Active_Rem_que=$m;$warning;$critical;;"
