...
$m = getCounter "MSExchangeTransport Queues" "Retry Mailbox Delivery Queue Length" "_total"
	
# Check thresholds for user count
$state = setState $m $warning $critical

$status_msg = "Retry mailbox delivery queue length is $m"

$perfdata_msg = "Retry_Mail_Del_Que=$m;$warning;$critical;;"
