...
$m = getCounter "MSExchangeTransport Queues" "Retry Non-Smtp Delivery Queue Length" "_total"
	
# Check thresholds for user count
$state = setState $m $warning $critical

$status_msg = "Retry non-smtp delivery queue length is $m"

$perfdata_msg = "Retry_NonSMTP=$m;$warning;$critical;;"
