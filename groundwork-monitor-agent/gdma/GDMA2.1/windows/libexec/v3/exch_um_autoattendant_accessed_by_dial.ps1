...
param
(
    [int]$warning   = 100, # not used
    [int]$critical  = 100, # not used
	[switch]$verbose,
    [switch]$help
)
...
Usage:
	...
	<plugin name> -verbose -help
  
	This plugin checks performance counter value
    
        MSExchangeUMAutoAttendant\Directory Accessed by Dial by Name
        MSExchangeUMAutoAttendant\Directory Accessed by Dial by Extension
        MSExchangeUMAutoAttendant\Directory Accessed by Dial by Spoken Name
...
$n = getCounter "MSExchangeUMAutoAttendant" "Directory Accessed by Dial by Name"
$e = getCounter "MSExchangeUMAutoAttendant" "Directory Accessed by Dial by Extension"
$s = getCounter "MSExchangeUMAutoAttendant" "Directory Accessed by Dial by Spoken Name"

$status_msg = "Directory accessed by dial - name: $n, extension: $e, spoken name: $s"

$perfdata_msg = "dir_by_name=$n;;;; dir_extension=$e;;;; dir_spoken=$s;;;;"
