...
Usage:
	...
	This plugin checks performance counter value
        ...
        MSExchangeUMAutoAttendant\Business Call Hours
        MSExchangeUMAutoAttendant\Out of Hours Calls
        MSExchangeUMAutoAttendant\Total Calls
...
$b = getCounter "MSExchangeUMAutoAttendant" "Business Call Hours"
$o = getCounter "MSExchangeUMAutoAttendant" "Out of Hours Calls"
$t = getCounter "MSExchangeUMAutoAttendant" "Total Calls"


$status_msg = "Auto attendant calls - business hours: $b, out of hours: $o, total: $t"

$perfdata_msg = "Business=$b;;;; After=$o;;;; Total=$t;;;;"
