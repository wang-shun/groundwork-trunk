...
Usage:
	...
	This plugin checks performance counter value
        ...
        MSExchangeUMAutoAttendant\Calls Disconnected by UM on Irrecoverable External Error
...
$m = getCounter "MSExchangeUMAutoAttendant" "Calls Disconnected by UM on Irrecoverable External Error"

$status_msg = "Total calls disconnected after irrecoverable external error is/are $m"
