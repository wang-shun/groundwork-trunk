...
Usage:
	...
	This plugin checks performance counter value
        ...
        MSExchangeUMAutoAttendant\% Successful Calls
...
$m = getCounter "MSExchangeUMAutoAttendant" "% Successful Calls"
	
$status_msg = "Success rate of the auto attendant completing calls is $m%"
