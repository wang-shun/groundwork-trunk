...
Usage:
	...
	mem_avail.ps1 -warning <warning value> -critical <critical value> -verbose -help

	This plugin checks for available physical memory. This should remain above 100 MB 
	at all times. The threshold default values are: 
	warning = $warning, critical = $critical megabytes. 
...
#	Fork64IfWoW
	...
	$m = getCounter "Memory" "Available Mbytes" 
	...
	$status_msg = "There are $m megabytes of memory free"
	$perfdata_msg = "free_memory=$m;$warning;$critical;;"
