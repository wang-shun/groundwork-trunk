...
Function f_help()
  ...
  str=str&"cscript mssql_transactions.vbs -h hostname -d database -w warning_level -c critical_level [-user username -pass password [-domain domain]]"
  str=str&vbCrlF
  ...
  str=str&vbCrlF
  str=str&"Example: cscript mssql_transactions.vbs -h Ser1 -d * -w 30 -c 70 [-user Ser1\Administrator -pass password -domain ITSP]"
  wscript.echo str
end function
'******************************
'** Main program
