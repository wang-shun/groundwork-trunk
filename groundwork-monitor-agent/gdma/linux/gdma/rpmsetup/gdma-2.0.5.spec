...
%changelog
* Mon Jun 30 2008 Glenn Herteg <gherteg@groundworkopensource.com> 2.0.5
- replaced the check_mem.pl plugin with one that accepts -F and -U options
