...
Function CheckCounterEx(strComputer,strClass,strWhere,strProperty,strUser,strPassword)
	...
	for Each objOS In colOS
		if strComp ( objOS.Name , strComputer , 1) = 0 then
		    ...
		    CheckCounterEx = ojbOS.Properties_(strProperty)( ".")
		    exit Function
		  end if
		end if
	next
...
Function f_help()
  ...
  str=str&vbCrlF
  str=str&"Example: cscript check_counter2.vbs -h Ser1 -class Win32_PerfRawData_PerfOS_Memory -where _Total -prop PagesPerSec -w 100000 -c 200000 [-user Ser1\Administrator -pass password] "
  wscript.echo str
end function
