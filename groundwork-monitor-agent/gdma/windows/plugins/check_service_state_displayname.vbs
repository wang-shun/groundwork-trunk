...
Function CheckService(strComputer , Service)		
	...
	for Each objOS In colOS		
		wscript.echo objOS.DisplayName & " is " & objOS.State		
	next
End Function
...
Function CheckServiceEx( strComputer , Service , strUser , strPassword)	
	...
	Else
		Service = "'" & Service & "'"
		Sql = "Select DisplayName,State From Win32_Service Where Name=" & Service
	End If
...
str=str&"cscript check_service_state_displayname.vbs -h hostname -s service_displaynames [-user username -pass password]"
str=str&vbCrlF
...
str=str&vbCrlF
str=str&"Example: cscript check_service_state_displayname.vbs -h Ser1 -s ""Wireless Configuration,Automatic Updates"" [-user SER1\Administrator -pass password] "&vbCrlF
str=str&"Example: cscript check_service_state_displayname.vbs -h Ser1 -s * [-user SER1\Administrator -pass password] "&vbCrlF
wscript.echo str
end function
