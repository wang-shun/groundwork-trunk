...
Function CheckService(strComputer , Service)		
	...
	if colOS.count = 0 then
		WScript.Echo "Service " & Service & " does not exist"
	End If
	for Each objOS In colOS		
		wscript.echo objOS.Name & " is " & objOS.State		
	next
End Function
...
str=str&"cscript check_service_state_name.vbs -h hostname -s Service_names [-user username -pass password]"
str=str&vbCrlF
...
str=str&vbCrlF
str=str&"Example: cscript check_service_state_name.vbs -h Ser1 -s ""wmi,WINS"" [-user SER1\Administrator -pass password] "&vbCrlF
str=str&"Example: cscript check_service_state_name.vbs -h Ser1 -s * [-user SER1\Administrator -pass password] "&vbCrlF
wscript.echo str
end function
