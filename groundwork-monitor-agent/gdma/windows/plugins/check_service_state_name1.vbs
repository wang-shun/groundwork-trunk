...
Function CheckService(strComputer , Service)		
	...
	If Service = "*" then
		Sql = "Select Name,State From Win32_Service"
	Else
		Service = "'" & Service & "'"
		Sql = "Select Name,State From Win32_Service Where Name=" & Service
	End If
	...
	for Each objOS In colOS		
		StrResult = strResult & objOS.Name & " is " & objOS.State & ";;"
	next	
End Function
...
str=str&"cscript check_service_state_name1.vbs -h hostname -s Service_names [-user username -pass password]"
str=str&vbCrlF
str=str&"-h hostname                 	Host name."&vbCrlF
str=str&"-s Service_names         		Service names,multiple processes will be enclosed in multiple quotes and separated by commas."&vbCrlF
...
str=str&vbCrlF
str=str&"Example: cscript check_service_state_name1.vbs -h Ser1 -s ""wmi,WINS"" [-user SER1\Administrator -pass password] "&vbCrlF
str=str&"Example: cscript check_service_state_name1.vbs -h Ser1 -s * [-user SER1\Administrator -pass password] "&vbCrlF
wscript.echo str
end function
