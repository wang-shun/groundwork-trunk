...
public abstract class VemaBaseVM extends GWOSEntity
{
    ...
    // constructors
    // -------------------------------------------------------------------
    protected     VemaBaseVM()            { /* nothing to do! */      }
    protected     VemaBaseVM(String name) { vmName = name;            }
	...
	public void setVMName(     String vm    ) { vmName        = vm;    } 
    ...
    public void mergeInNew(VemaBaseVM update)
    {
        if (update == null) 
            return;
    ...
    public String formatSelf( VemaBaseVM o )
    {
    ...
    public String getXML(String action)
    {
        ...
        addAttribute("Host",        this.vmName);
        addAttribute("Description", this.vmName);
        addAttribute("DisplayName", this.vmName);
        ...
        if(this.macAddress != null) // and...
            ...
            else                                  addAttribute("Device", this.vmName);
        else                                      addAttribute("Device", this.vmName);
        ...
        else if (action.equals(GWOSEntity.ACTION_MODIFY))
        {
            ...
            /* If VM is powered down or suspended auto acknowledge */
