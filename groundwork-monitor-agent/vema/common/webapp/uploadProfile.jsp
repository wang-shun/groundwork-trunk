			...
			<div class="boxbody">
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" name="propFile" value="/tmp/" />(Path
							for the gwos_@appserver_lowercase@.xml file on your
							@appserver_camelcase@ server)</td>
					</tr>
				</table>
				<p align="center">
					<input type="button" value="Home"
						onclick="location.href='index.html'" class="button" /><input
						type="submit" name="export" value="Export" class="button" />
				</p>
			</div>
		</div>
