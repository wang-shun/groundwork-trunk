...
/**
 * VemaRhevMulti - encapsulates VemaRhev (single Rhev management host query class) into
...
public class VemaRhevMulti implements VemaMulti
{
    private static org.apache.log4j.Logger log = Logger.getLogger( VemaRhevMulti.class );
    ...
    public VemaRhevMulti( ArrayList<VemaBaseHostURI> hostList )
    {
        for( VemaBaseHostURI hostURI : hostList )
            handleList.add( new VemaHandle( hostURI, new VemaRhev() ) );
    }
