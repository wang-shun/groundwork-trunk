...
sub usage
{
	...
	print "<warn> = Number of sockets connected above which a warning message will be generated.[Default = 256]\n";
	print "<crit> = Number of sockets connected above which a critical message will be generated.[Default = 512]\n";
	exit $ERRORS{"UNKNOWN"};
