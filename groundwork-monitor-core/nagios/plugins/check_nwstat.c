...
Changelog:
06/20/2006 (added):	Load 1,5,15 Perfdata
			Connections Perfdata
			User Logged In Perfdata
			Abend Count Perfdata
			Cache Buffers Perfdata
			Volume KB Free Perfdata
			Volume % Free Perfdata
			Current Service Process Perfdata
07/02/2006 (added): 	Total Cache Buffers Perfdata
			Volume Percent Purgeable Perfdata	
			Dirty Cache Buffers Perfdata

 $Id: check_nwstat.c, v 1.30 patched 2006/07/02 christian mies (mail@etmiesje.de)
