...
%changelog
* Tue Sep 28 2010 Glenn Herteg <support@groundworkopensource.com> 0.3.0
- improve logic surrounding peer-to-peer connection failures, to ensure
  that the code will sense and attempt to recover from such failures
