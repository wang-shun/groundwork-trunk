      ...
      <div id="expander">
         ...
         <div id="content-container">
           ...
           style="min-width:963px; width:100%;">
             <tr>
               <td colspan="2" valign="top"><p:region regionName='top' regionID='top'/></td>
	     </tr>
             <tr>
               <td width="50%" valign="top"><p:region regionName='centerCol1' regionID='centerCols'/></td>
               <td width="50%" valign="top"><p:region regionName='centerCol2' regionID='centerCols'/></td>
             </tr>
             <tr>
	       <td colspan="2"><p:region regionName='dash-bottom' regionID='dash-bottom'/></td>
	     </tr>
            </table>
            <hr class="cleaner"/>
         </div>
