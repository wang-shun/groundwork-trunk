...
<head>
   ...
   <!--[if lt IE 8]><link rel="stylesheet" type="text/css" id="lt_ie8_css" href="/portal-core/themes/groundwork/portal_style_ie_lt8.css" /><![endif]-->
   <!-- insert header content that was possibly set by portlets on the page -->
   <p:headerContent/>
       <!--[if lt IE 8]><link rel="stylesheet" type="text/css" href="/portal-identity/style-ie.css" /><![endif]--> 
	
   <!-- Note: do not change order of these files! -->
   ...
   <script type="text/javascript" src="/portal-core/js/ui.resizable.min.js"></script>
	
   <!-- JS files for Tab scrolling -->
   <script type="text/javascript" src="/portal-core/js/jquery.dimensions.min.js"></script>
         ...
         <div id="content-container">
            <table border="0" cellpadding="0" cellspacing="0" style="width:80%;">
                <tr>
                    ...
                    <td width="80%" height="100%" valign='top'><p:region regionName='left' regionID='left'/></td>
                   <!--  <td width="20%" valign="top"> -->

                        <!-- insert the content of the 'bottom' region of the page, and assign the css selector id 'regionB' -->
                       <%--  <p:region regionName='bottom' regionID='bottom'/>
                    </td> --%>
                </tr>
            </table>
            <hr class="cleaner"/>
