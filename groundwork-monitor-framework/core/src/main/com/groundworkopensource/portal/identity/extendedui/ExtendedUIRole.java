...
public class ExtendedUIRole implements Serializable {
	...
	/** HGList to be shown */
	private List<String> hgList=null;

	private   List<String> sgList = null;
	...
	public   List<String>  getHgList() {
		return this.hgList;
	}

	public void setHgList( List<String> hgList) {
		this.hgList = hgList;
	}

	public  List<String> getSgList() {
		return this.sgList;
	}

	public void setSgList( List<String> sgList) {
		this.sgList = sgList;
	}
