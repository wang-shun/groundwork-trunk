	...
	public static PropertyContext findAdminPreferencesByWindowInstanceId(
		...
		if (instanceId != null) {
			...
			try {
				...
				String sqlQuery = "select e.NAME,v.jbp_value from JBP_INSTANCE i,JBP_INSTANCE_PER_USER u,JBP_PORTLET_STATE_ENTRY e, JBP_PORTLET_STATE_ENTRY_VALUE v where i.ID=?  AND i.PK=u.INSTANCE_PK and u.USER_id=? and e.PK=v.PK and e.ENTRY_KEY=SUBSTRING_INDEX(u.PORTLET_REF,'_',-1)";
