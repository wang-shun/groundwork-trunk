...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS HelpDeskLookupTable (
      ...
      -- FIX LATER:  The LastChangeTime field will be supported in a future release.
      -- We are not including it in this release solely to ease the transition from
      -- a MySQL-based deployment to a PostgreSQL-based deployment.
      -- ,
      -- LastChangeTime timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
