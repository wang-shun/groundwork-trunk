...
#
# Copyright 2007, 2011, 2012, 2014 GroundWork Open Source, Inc.
# All rights reserved. Use is subject to GroundWork commercial license terms.
#
# This version is compatible with a NeDi 1.1 beta database and its associated
# nedi.conf file, while remaining compatible with NeDi 1.0.7-1.
#
