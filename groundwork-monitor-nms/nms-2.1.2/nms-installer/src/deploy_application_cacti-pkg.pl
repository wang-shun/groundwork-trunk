...
deploy_application_cacti_pkg()
{
	...
	my $gw_home = "/usr/local/groundwork";
#1    my $sourcedir = "$enterprise_home/bin/components/guava-packages/cacti";
...
#1    {
#1        leave_with_error("Can only install a Cacti package if Groundwork is installed.");
#1    }
...
#1	`cp -rf $enterprise_home/bin/components/guava-packages/svcactigraph/* $guavapackagedir/svcactigraph`;
