...
#1        my $sourcedir = "$enterprise_home/bin/components/guava-packages/nedi";
...
#1        {
#1                leave_with_error("Can only install a Nedi package if Groundwork is installed.");
#1        }
...
#1        my $description = "NeDi [$nedi_short_hostname]";
