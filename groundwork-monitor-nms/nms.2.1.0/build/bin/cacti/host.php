		...
		<table width="100%" align="center">
			...
			<tr>
				...
				<?php }else if ($host["availability_method"] == AVAIL_PING) {
					if (($host["ping_method"] == PING_ICMP) && ($config["cacti_server_os"] != "win32")) {
						$result = explode("\t", trim(shell_exec(read_config_option("path_webroot") . "/cli/cacti_ping_executor " . $host["id"] . " " . $host["ping_timeout"] . " " . $host["ping_retries"])));
