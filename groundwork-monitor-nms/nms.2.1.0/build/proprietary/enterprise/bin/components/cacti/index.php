...
function find_best_path($binary_name) {
	...
	if ($config["cacti_server_os"] == "win32") {
		...
		$search_paths = array("/usr/local/groundwork/nms/tools/rrdtool/bin", "/usr/local/groundwork/nms/tools/php/bin", "/usr/local/groundwork/nms/tools/net-snmp/bin", "/bin", "/sbin", "/usr/bin", "/usr/sbin", "/usr/local/bin", "/usr/local/sbin");
	}
