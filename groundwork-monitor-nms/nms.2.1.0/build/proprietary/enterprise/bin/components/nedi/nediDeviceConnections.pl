...
eval '(exit $?0)' && eval 'exec /usr/local/groundwork/nms/tools/perl/bin/perl $0 ${1+"$@"}'
&& eval 'exec /usr/local/groundwork/nms/tools/perl/bin/perl $0 $argv:q'
if 0;
...
$p = '/usr/local/groundwork/nms/applications/nedi';
