# This is the groundwork-nms-weathermap spec file needed to construct the
# Groundwork Monitor NMS Weathermap RPM.
...
%define	name		groundwork-nms-weathermap
...
Summary: GroundWork Monitor NMS Weathermap Module
License: All rights reserved.  Use is subject to GroundWork commercial license terms.
Group: Applications/Monitoring
Name: %{name}
Prefix: %{gwpath}
Release: %(cat %(echo $PWD)/rpmsetup/project.properties | fgrep 'org.groundwork.rpm.release.weathermap.number' | awk '{ print $3; }')
...
# groundwork-nms-weathermap RPM because we're adding certain new files and
...
a version of Weathermap which is integrated into the monitoring system.
...
if [ "$1" = 0 ]; then
    ...
    # FIX MAJOR:  we should probably kill any existing nms services, somehow
...
# The groundwork-nms-weathermap RPM should depend on the groundwork-nms-core RPM and include this file tree:
# %{gwpath}/nms/applications/weathermap/...
