...
<td class=row2 align=left valign=center valign=top><input class=submitbutton type=submit name=add_services value="Add Data Set(s)"></td>
</tr>
</table>
...
<td class=row2 align=left valign=center valign=top><input class=submitbutton type=submit name=add_hosts value="Add Host(s)"></td>
</tr>
</table>
