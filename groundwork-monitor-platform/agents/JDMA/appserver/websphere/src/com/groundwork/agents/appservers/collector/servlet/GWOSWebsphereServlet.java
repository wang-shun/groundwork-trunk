...
//	private static org.apache.log4j.Logger log = Logger.getLogger(GWOSWebsphereServlet.class);
	...
	{
        ConnectorBean bean = (ConnectorBean)request.getSession().getAttribute("connectorBean");
        if (bean == null) {
            bean = new ConnectorBean();
            request.getSession().setAttribute("connectorBean", bean);
        }
