...
public class ProfileBuilder {
	...
	private static org.apache.log4j.Logger log = Logger.getLogger(ProfileBuilder.class);
//    private static JDMALog log = new JDMALog();
	...
	private String footerBuilder(String serviceName) {
		...
		builder.append("<prop name=\"parallelize_check\"><![CDATA[0]]></prop>\n");
		builder
	...
	private void write(String finalConfig)
	{
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(path
					+ "service-profile-" + appServerName + ".xml"));
