...
public class PropertyFileBuilder {
	...
	private static org.apache.log4j.Logger log = Logger.getLogger(PropertyFileBuilder.class);
	...
	public PropertyFileBuilder(String path, String appServerName,
		...
		if (path != null && appServerName != null && staticProps != null
			...
			log.error("Invalid path or appservername or static properties or propFile");
		}
