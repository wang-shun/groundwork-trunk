...
<form name="uploadForm"
	...
	<p align="center">
	<img align="top" src="images/gwlogo.png" width="264px">
</p>
<p align="center">
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="propFile" value="@appserver_config_path@"/>(Path for the gwos_@appserver_lowercase@.xml file on your @appserver_camelcase@ server). Usually your classpath.</td>
	</tr>
</table>
<p align="center">
