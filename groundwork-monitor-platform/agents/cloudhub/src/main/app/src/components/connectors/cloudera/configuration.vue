<template>
    <div class="container-fluid">
        ...
        <div class="row margin-top90">
            ...
            <div class="col-md-4">
                <p><strong>Cloudera Connector</strong></p>
                <hr />
                <form class="form-horizontal">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="config-server" class="col-sm-4 control-label">Cloudera Server</label>
                        <div class="col-sm-8">
                            <input type="text" :class="{'form-control': true, 'invalid': errors.has('config-server') }" id="config-server" name="config-server" placeholder="Cloudera Server" v-model="connection.server" v-validate.initial="{ rules: { required: true, regex: /^[a-zA-Z0-9_\.\-\:]*$/ } }" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input autocomplete="new-password" type="text" :class="{'form-control': true, 'invalid': errors.has('config-server-username') }" id="config-server-username" name="config-server-username" placeholder="Username" v-model="connection.username" v-validate.initial="{ rules: { required: true } }" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input autocomplete="new-password" type="password" :class="{'form-control': true, 'invalid': errors.has('config-server-password') }" id="config-server-password" name="config-server-password" placeholder="" v-model="connection.password" v-validate.initial="{ rules: { required: true } }" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                            <div class="checkbox">
                                <label>
                                  <input id="config-prefix" name="config-prefix" type="checkbox" v-model="common.prefixServiceNames">  Prefix Service Names with Cluster?
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-vcentered">
                        ...
                        <div class="col-sm-7 col-xs-12">
                          <div class="checkbox">
                            <span class="pull-left col-sm-6 hidden-xs">Port Number:</span>
                            <span class="col-xs-12 visible-xs">Port Number:</span>
                            <span class="col-sm-6 col-xs-12 no-padding-right short-padding-left">
            ...
            <div class="col-md-4">
                <p><strong>Service Views</strong></p>
                <hr />
                <form class="form-horizontal">
        ...
        <hsy-dialog class="confirm" v-model="prefix">
            ...
            <div slot="body">
                <div>Cluster Prefix has changed. Changing the prefix will rename all of your Hostnames for Cloudera Services.<br /><br />Are you sure you want to proceed?</div><br />
                <div>
...
<script>
import ClouderaService from './cloudera-service'

export default {
  name: 'Configuration',
  data () {
    return {
      service: new ClouderaService(),
      configName: '',
      state: '',
  ...
  methods: {
    retrieve: function(configName) {
      ...
      this.service.retrieve(configName, function(configurationData)
      {
        ...
        self.metricsLink = '/metrics/cloudera?name=' + self.common.configurationFile + '&profile=' + self.common.agentId;
      });
    },
    ...
    save: function(event, skipCheck) {
        ...
        function(result) {
            ...
            self.$router.push({ path: '/configuration/cloudera', query: { name: self.common.configurationFile }})
        });
    },
