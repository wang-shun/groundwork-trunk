...
export default class DockerService {
    retrieve(configName, callback) {
        serverService.retrieve('docker', configName ? ('config?name=' + configName) : 'config').then(response => {
    ...
    save(data, callback) {
        serverService.post('docker', 'config', data).then(response => {
    ...
    test(data, what, callbackSuccess, callbackError) {
        serverService.post('docker', 'test', data, [what]).then(response => {
