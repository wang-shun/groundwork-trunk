<template>
    <div class="container-fluid">
        ...
        <div class="row margin-top90">
            ...
            <div class="col-md-4">
                <p><strong>VMware Connector</strong></p>
                <hr />
                <form class="form-horizontal">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="config-server-name" class="col-sm-4 control-label">VMware Server Name</label>
                      <div class="col-sm-8">
                        <input type="text" :class="{'form-control': true, 'invalid': errors.has('config-server-name') }" id="config-server-name" name="config-server-name" placeholder="VMware Server Name" v-model="connection.server" v-validate.initial="{ rules: { required: true, regex: /^[a-zA-Z0-9_\.\-\:]*$/ } }" />
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="config-server-uri" class="col-sm-4 control-label">Server URI</label>
                      <div class="col-sm-8">
                        <input type="text" :class="{'form-control': true, 'invalid': errors.has('config-server-uri') }" id="config-server-uri" name="config-server-uri" placeholder="Server URI" v-model="connection.uri" v-validate="{ rules: { required: true } }" />
                      </div>
                    </div>

                    <div class="form-group">
                        <label for="config-server-username" class="col-sm-4 control-label">Username</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="config-server-password" class="col-sm-4 control-label">Password</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                      <label for="config-check-interval" class="col-sm-4 control-label">Interval (min)</label>
                      <div class="col-sm-8">
                           <input id="config-check-interval" name="config-check-interval" style="width: 25%" type="number" :class="{'form-control': true, 'invalid': errors.has('config-check-interval') }" min="1" max="9999" v-model="common.checkIntervalMinutes" v-validate="{ rules: { required: true } }" />
                      </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <hr />
                <form class="form-horizontal">
                    <div class="form-group" v-for="view in views">
                        <div class="col-sm-offset-3 col-sm-3">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" v-model="view.enabled" :disabled="view.name == 'Hypervisor'"> {{view.name}}
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <hsy-dialog class="confirm" v-model="prefix">
            ...
            <div slot="body">
                <div>Cluster Prefix has changed. Changing the prefix will rename all of your Hostnames for VMware Services.<br /><br />Are you sure you want to proceed?</div><br />
                <div>
  ...
  methods: {
    retrieve: function(configName) {
      ...
      this.service.retrieve(configName, function(configurationData)
      {
        ...
        self.metricsLink = '/metrics/vmware?name=' + self.common.configurationFile + '&profile=' + self.common.agentId;
      });
    },
    ...
    save: function(event, skipCheck) {
        ...
        function(result) {
            ...
            self.$router.push({ path: '/configuration/vmware', query: { name: self.common.configurationFile }})
        });
    },
