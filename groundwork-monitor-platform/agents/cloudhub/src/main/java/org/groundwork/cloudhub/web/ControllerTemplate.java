...
@Controller
@RequestMapping("/yourControllerNameGoesHere")
public class ControllerTemplate extends HostController {
    ...
    public ModelAndView navigateToProfile(@ModelAttribute(value = "configBean") CiscoConfiguration configBean, HttpServletRequest request) {
        ...
        try {
            ...
            log.error("Exception occurred while navigating cisco profile", ex);
        }
