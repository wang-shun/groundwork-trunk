...
<title>CloudHub for Cloudera</title>
...
<body id="dt_example">
	<form:form name="assignForm" id="assignForm" modelAttribute="profileBean" method="POST" action="/cloudhub/mvc/cloudera/saveConnectionProfile">
		...
		<div id="container">
			...
			<div id="messages" class="message">
				<div id="testConResultMsg">
					...
					<c:if test="${result == 'success'}">
						<p><font size="3">Cloudera profile updated successfully.</font></p>
					</c:if>
	
					<c:if test="${result == 'savefailure'}">
						<p><font size="3" color="red">Sorry some problem occurred in saving Cloudera profile!</font></p>
					</c:if>
			...
			<div id="controlbg">
				...
				<div class="controlheader heading3">Controller thresholds</div>
			...
			<div id="controlbg">
				...
				<div class="controlheader heading3">Aggregate and Volume thresholds</div>
						...
						<tbody>
							...
							<c:forEach items="${profileBean.vmMetrics}" var="metric"
								...
								<tr>
									...
									<td class="tableRow5b">
										<form:input type="text" id="vm_customName_${rowCounter.count}" class="customName" path="vmMetrics[${rowCounter.index}].customName" value="${metric.customName}" size="15" maxlength="60"/>
