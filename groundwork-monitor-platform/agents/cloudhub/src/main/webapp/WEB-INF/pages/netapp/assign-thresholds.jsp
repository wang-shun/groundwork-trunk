...
<title>CloudHub for NetApp</title>
...
<body id="dt_example">
	<form:form name="assignForm" id="assignForm" modelAttribute="profileBean" method="POST" action="/cloudhub/mvc/netapp/saveConnectionProfile">
			...
			<div id="messages" class="message">
				<div id="testConResultMsg">
					...
					<c:if test="${result == 'success'}">
						<p><font size="3">NetApp profile updated successfully.</font></p>
					</c:if>
	
					<c:if test="${result == 'savefailure'}">
						<p><font size="3" color="red">Sorry some problem occurred in saving NetApp profile!</font></p>
					</c:if>
