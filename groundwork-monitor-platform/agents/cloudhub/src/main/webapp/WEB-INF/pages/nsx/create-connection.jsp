...
<head>
    ...
    <title>Groundwork Cloud Hub for NSX</title>
    ...
    <script>
        ...
        function testForm(form, action) {
            postTestConnection(form, action, "NSX");
        }
...
<body id="dt_example">
<form:form id="createNSXConnectionForm" commandName="configBean" method="POST" action="/cloudhub/mvc/nsx/saveConnectionConfiguration">
<div id="container">
<!-- <p align="center">
    <img align="top" src="images/logo.png">
</p> -->
<p align="center" class="agent_title">Cloud Hub Configuration Wizard for VMWare NSX</p>

<div id="testConWaitMsg" class='message' style="display:none">
    <p><img src="/cloudhub/resources/images/loader.gif"/>Testing connection to Groundwork and NSX servers!</p>
</div>
<div id='testConResultMsg'>
    <c:if test="${result == 'nsxerror'}">
        <div id="messages" class='redMessage'>
            <p>NSX server connection failed!</p>
            <p>${errorMessage}</p>
        </div>
    </c:if>
    ...
    <c:if test="${result == 'savesuccess'}">
        <div id="messages" class='message'>
            <p class='message'>NSX server connection saved successfully. (Remember to test connection to ensure connection validity)</p>
        </div>
    </c:if>
    <c:if test="${result == 'savefailure'}">
        <div id="messages" class='redMessage'>
            <p class='message'>Sorry some problem occurred in saving NSX server connection.!</p>
            <p>${errorMessage}</p>
        </div>
    </c:if>
...
<div id="controlbg">
    ...
    <div class="controlheader">NSX / Groundwork Connection.
    ...
    <div class="controlcontent">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display"
            ...
            <tr>
                <td class="group2">VMware NSX Server URL:</td>
                ...
                <td class="group2">http://nsx-host.yourdomain.com</td>
            </tr>

            <tr>
                <td class="group2">VMware NSX Server Username:</td>
                <td class="group2"><form:input type="text" class="text required"
            ...
            <tr>
                <td class="group2">VMware NSX Server Password:</td>
        ...
        <p align="center">
            ...
            <c:if test="${configBean.common.testConnectionDisabled == false}">
                <input id="testConnectionBtn" value="Test Connection" class="button-l" type="button" onclick="testForm('createNSXConnectionForm', '/cloudhub/mvc/nsx/testConnection')"/>
            </c:if>
            ...
            <input name="save" id='saveButton' value="Save" class="button-l" type="button" onclick="saveForm('createNSXConnectionForm', '/cloudhub/mvc/nsx/saveConnectionConfiguration')"/>
