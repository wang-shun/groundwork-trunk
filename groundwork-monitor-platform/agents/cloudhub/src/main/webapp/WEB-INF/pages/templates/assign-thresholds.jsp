...
<title>CloudHub for $ConnectorName</title>
...
<body id="dt_example">
	<form:form name="assignForm" id="assignForm" modelAttribute="profileBean" method="POST" action="/cloudhub/mvc/$connector/saveConnectionProfile">
			...
			<div id="messages" class="message">
				<div id="testConResultMsg">
					...
					<c:if test="${result == 'success'}">
						<p><font size="3">$ConnectorName profile updated successfully.</font></p>
					</c:if>
	
					<c:if test="${result == 'savefailure'}">
						<p><font size="3" color="red">Sorry some problem occurred in saving $ConnectorName profile!</font></p>
					</c:if>
