 ...
 * @version $Id: Component.java 7205 2007-07-05 20:15:48Z rruttimann $
 */
public interface Component extends AttributeData
{
    /** the name that identifies this entity in the system */
    static final String ENTITY_TYPE_CODE = "COMPONENT";
        
	/** Spring bean interface id */
	static final String INTERFACE_NAME = "com.groundwork.collage.model.Component";
	
	/** Hibernate component name that this entity service using */
	static final String COMPONENT_NAME = "com.groundwork.collage.model.impl.Component";
	 ...
	 * property maps.
	 */
	static final String HP_ID = "componentId";
	static final String HP_NAME = "name";
	static final String HP_DESCRIPTION = "description";

	/** Entity Property Constants */
	static final String EP_ID = "ComponentId";
	static final String EP_NAME = "Component";
