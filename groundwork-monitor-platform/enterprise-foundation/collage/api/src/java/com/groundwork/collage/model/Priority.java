 ...
 * @version $Id: Priority.java 7205 2007-07-05 20:15:48Z rruttimann $
 */
public interface Priority extends AttributeData
{
    /** the name that identifies this entity in the system */
    static final String ENTITY_TYPE_CODE = "PRIORITY";
        
	/** Spring bean interface id */
	static final String INTERFACE_NAME = "com.groundwork.collage.model.Priority";
	
	/** Hibernate component name that this entity service using */
	static final String COMPONENT_NAME = "com.groundwork.collage.model.impl.Priority";
	 ...
	 * property maps.
	 */
	static final String HP_ID = "priorityId";
	static final String HP_NAME = "name";
	static final String HP_DESCRIPTION = "description";

	/** Entity Property Constants */
	static final String EP_ID = "PriorityId";
	static final String EP_NAME = "Priority";
