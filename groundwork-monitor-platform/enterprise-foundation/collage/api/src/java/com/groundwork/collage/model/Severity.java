 ...
 * @version $Id: Severity.java 7205 2007-07-05 20:15:48Z rruttimann $
 */
public interface Severity extends AttributeData
{
    /** the name that identifies this entity in the system */
    static final String ENTITY_TYPE_CODE = "SEVERITY";
        
	/** Spring bean interface id */
	static final String INTERFACE_NAME = "com.groundwork.collage.model.Severity";
	
	/** Hibernate component name that this entity service using */
	static final String COMPONENT_NAME = "com.groundwork.collage.model.impl.Severity";
	 ...
	 * property maps.
	 */
	static final String HP_ID = "severityId";
	static final String HP_NAME = "name";
	static final String HP_DESCRIPTION = "description";

	/** Entity Property Constants */
	static final String EP_ID = "SeverityId";
	static final String EP_NAME = "Severity";
