 ...
 * @version $Id: TypeRule.java 7205 2007-07-05 20:15:48Z rruttimann $
 */
public interface TypeRule extends AttributeData
{
    /** the name that identifies this entity in the system */
    static final String ENTITY_TYPE_CODE = "TYPE_RULE";
        
	/** Spring bean interface id */
	static final String INTERFACE_NAME = "com.groundwork.collage.model.TypeRule";
	
	/** Hibernate component name that this entity service using */
	static final String COMPONENT_NAME = "com.groundwork.collage.model.impl.TypeRule";
	 ...
	 * property maps.
	 */
	static final String HP_ID = "typeRule";
	static final String HP_NAME = "name";
	static final String HP_DESCRIPTION = "description";

	/** Entity Property Constants */
	static final String EP_ID = "TypeRuleId";
	static final String EP_NAME = "TypeRule";
	static final String EP_DESCRIPTION = "Description";
	
    Integer getTypeRuleId();

    void setTypeRuleId(Integer typeId);
