...
public class HostgroupSoapBindingStub extends GWSoapBindingStub  implements WSHostGroup {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getHostGroups");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "type"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "HostGroupQueryType"), HostGroupQueryType.class, false, false);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getHostGroupsReturn"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getHostGroupsByString");
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "appType"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);        
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "deep"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "WSFoundationCollection"));
        oper.setReturnClass(WSFoundationCollection.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getHostGroupInfoReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "WSFoundationException"),
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getHostGroupsByCriteria");
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "WSFoundationCollection"));
        oper.setReturnClass(WSFoundationCollection.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getHostGroupsByCriteriaReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "WSFoundationException"),
    ...
    public HostgroupSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public HostgroupSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public HostgroupSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://model.ws.foundation.groundwork.org", "HostGroupInfoQueryType");
            cachedSerQNames.add(qName);
            cls = HostGroupInfoQueryType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);            
    ...
    public WSFoundationCollection getHostGroups(org.groundwork.foundation.ws.model.HostGroupQueryType hostGroupQueryType,
            String value, String applicationType, boolean deep,  int fromRange, int toRange, SortCriteria orderedBy) throws java.rmi.RemoteException, WSFoundationException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("/foundation-webapp/services/wshostgroup");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fws", "getHostGroups"));

        setRequestHeaders(_call);
        setAttachments(_call);
         try {       
            java.lang.Object _resp = _call.invoke(new java.lang.Object[] {hostGroupQueryType, value, applicationType, new java.lang.Boolean(deep), fromRange, toRange, orderedBy});
     ...
     * data extension.
     */
    public WSFoundationCollection getHostGroupsByString(String type, 
            String value,
    ...
    throws RemoteException, WSFoundationException
    {
        ...
        if (type != null) 
        {
            queryType = HostGroupQueryType.fromValue(type);
        }
        ...
        return getHostGroups(queryType, 
                        value,
                        applicationType, 
                        bDeep, 
                        intFromRange, 
    ...
    public WSFoundationCollection getHostGroupInfo(String type, String value) throws java.rmi.RemoteException, WSFoundationException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fws", "getHostGroupInfo"));

        setRequestHeaders(_call);
        setAttachments(_call);
         try {       
            java.lang.Object _resp = _call.invoke(new java.lang.Object[] {type, value});
    ...
    public WSFoundationCollection getHostGroupsByCriteria(Filter filter, Sort sort, int firstResult, int maxResults, boolean bDeep)  throws RemoteException, WSFoundationException
    {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fws", "getHostGroupsByCriteria"));

        setRequestHeaders(_call);
        setAttachments(_call);
        try {        
             java.lang.Object _resp = _call.invoke(new java.lang.Object[] {filter, sort, firstResult, maxResults, bDeep});
