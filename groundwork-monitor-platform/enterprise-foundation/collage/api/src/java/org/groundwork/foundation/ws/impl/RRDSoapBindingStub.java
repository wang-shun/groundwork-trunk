...
public class RRDSoapBindingStub extends GWSoapBindingStub implements WSRRD {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "graphWidth"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "getGraphReturn"));
    ...
    public RRDSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RRDSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RRDSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public WSFoundationCollection getGraph(String hostName, String serviceName,
			long startDate, long endDate, String applicationType, int graphWidth) throws java.rmi.RemoteException, org.groundwork.foundation.ws.model.impl.WSFoundationException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("/foundation-webapp/services/wsrrd");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fws", "getGraph"));

        setRequestHeaders(_call);
        setAttachments(_call);
        try {        
            java.lang.Object _resp = _call.invoke(new java.lang.Object[] {hostName,serviceName, startDate, endDate, applicationType,  graphWidth});
