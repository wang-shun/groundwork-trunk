--$Id: monitor-data.sql 18751 2011-10-29 20:42:22Z ashanmugam $
--sMonitoring test data 
...
INSERT INTO MonitorServer(MonitorServerID,MonitorServerName,IP, Description) VALUES(1,'groundwork-monitor1', '192.168.1.251', 'Test Monitor 1');
INSERT INTO MonitorServer(MonitorServerID,MonitorServerName,IP, Description) VALUES(2,'groundwork-monitor2', '192.168.1.252', 'Test Monitor 2');
INSERT INTO MonitorServer(MonitorServerID,MonitorServerName,IP, Description) VALUES(3,'groundwork-monitor3', '192.168.1.253', 'Test Monitor 3');

-- Populate some devices

INSERT INTO Device(DeviceID,DisplayName,Identification, Description) VALUES(1,'groundwork', '192.168.1.100', 'Nagios Server');
INSERT INTO Device(DeviceID,DisplayName,Identification, Description) VALUES(2,'ex-svr-1', '192.168.1.101', 'Exchange Server');
INSERT INTO Device(DeviceID,DisplayName,Identification, Description) VALUES(3,'mysql-svr-1', '192.168.1.102', 'Database backend');
INSERT INTO Device(DeviceID,DisplayName,Identification, Description) VALUES(4,'app-svr-1', '192.168.1.103', 'Application server');
INSERT INTO Device(DeviceID,DisplayName,Identification, Description) VALUES(5,'app-svr-2', '192.168.1.104', 'Application Server');
...
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'DISK OK - free space: / 12524 MB (34%)', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 100.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_procs'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'System call sent warnings to stderr', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_procs'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_procs'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_procs'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 100.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_procs'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 100.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='apps2'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='apps2'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='apps2'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='apps2'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.5, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='apps2'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='site'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='site'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='site'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='site'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.95, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='site'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='itServices'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='itServices'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='itServices'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='itServices'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='itServices'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='organizations'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='organizations'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='organizations'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='organizations'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 97.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='organizations'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='wan'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='wan'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='wan'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='wan'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 98.80, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='wan'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='storage'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='storage'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='storage'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='storage'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.80, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='storage'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='fnp'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='fnp'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='fnp'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='fnp'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.90, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='fnp'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email atlanta'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email atlanta'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 14420000, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email atlanta'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 1, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email atlanta'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 99.90, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email atlanta'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email ny'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email ny'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email ny'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email ny'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 97.90, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email ny'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email miami'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email miami'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email miami'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email miami'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 98.90, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email miami'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());

INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastPluginOutput'), 'USERS OK - 2 users currently logged in', NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeUnknown'), 0, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='TimeCritical'), 4000000, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='isProblemAcknowledged'), 1, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='30DayMovingAvg'), 97.00, NOW());
INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='email minn'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='LastNotificationTime'), NOW(), NOW());
...
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueInteger, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxInteger1'), 99, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxLong1'), 999999999, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxDouble1'), 99.99, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueString,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxString2'), 'Jmx String Attribute', NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDate,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxDate2'), '2005-05-01', NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueBoolean, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxBoolean2'), 1, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueInteger, CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxInteger2'), 299, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueLong,    CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxLong2'), 299999999, NOW());
-- INSERT INTO ServiceStatusProperty(ServiceStatusID, PropertyTypeID, ValueDouble,  CreatedOn) VALUES ((SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='Runtime Attributes'), (SELECT PropertyTypeID FROM PropertyType WHERE Name='JmxDouble2'), 299.99, NOW());
...
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'),1,3,3,2,2,4,5, 'message_1', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1, -12345678);
...
INSERT INTO LogMessage(ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount, StateTransitionHash)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'),1,2,3,4,1,4,5, 'message_2', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1, -12345678);
...
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'),1,3,3,4,2,3,5, 'message_3', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_disk'),1,3,3,4,2,3,5, 'message_4', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'),1,3,3,4,2,3,5, 'message_5', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='local_users'),1,3,3,4,2,3,5, 'message_6', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1, (SELECT HostID FROM Host WHERE HostName='nagios'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='network_users' AND HostID=(SELECT HostID FROM Host WHERE HostName='nagios')),1,3,4,2,5,4,5, 'message_7', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),1,(SELECT HostID FROM Host WHERE HostName='nagios'),(SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='network_users' AND HostID=(SELECT HostID FROM Host WHERE HostName='nagios')),1,3,6,2,3,4,5, 'message_8', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES( (SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),2, (SELECT HostID FROM Host WHERE HostName='exchange'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='network_users' AND HostID=(SELECT HostID FROM Host WHERE HostName='exchange')),1,3,6,2,3,4,5, 'message_9', (NOW() - INTERVAL '60 DAYS'), '2006-11-23 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES((SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),2, (SELECT HostID FROM Host WHERE HostName='exchange'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='network_users' AND HostID=(SELECT HostID FROM Host WHERE HostName='exchange')),1,3,6,2,3,4,5, 'message_10', (NOW() - INTERVAL '60 DAYS'), '2006-11-17 11:04:58', NOW(), 1);
...
INSERT INTO LogMessage( ApplicationTypeID, DeviceID, HostStatusID, ServiceStatusID, SeverityID, ApplicationSeverityID, PriorityID, ComponentID, MonitorStatusID, OperationStatusID, TypeRuleID, TextMessage, FirstInsertDate, LastInsertDate, ReportDate, MsgCount)
VALUES((SELECT ApplicationTypeID FROM ApplicationType WHERE Name='NAGIOS'),2, (SELECT HostID FROM Host WHERE HostName='exchange'), (SELECT ServiceStatusID FROM ServiceStatus WHERE ServiceDescription='network_users' AND HostID=(SELECT HostID FROM Host WHERE HostName='exchange')),1,3,6,2,3,4,5, 'message_11', (NOW() - INTERVAL '60 DAYS'), '2006-11-18 11:04:58', NOW(), 1);
...
INSERT INTO Category(Name, Description,EntityTypeID) VALUES('Local_Services', 'First test category',(SELECT EntityTypeID FROM EntityType WHERE Name='HOSTGROUP'));
INSERT INTO CategoryEntity(ObjectID,CategoryID,EntityTypeID) VALUES ((select ServiceStatusID from ServiceStatus where ServiceDescription='local_disk' ), (select CategoryID from Category where Name='Local_Services'),(select EntityTypeID from EntityType where Name='SERVICE_STATUS'));
