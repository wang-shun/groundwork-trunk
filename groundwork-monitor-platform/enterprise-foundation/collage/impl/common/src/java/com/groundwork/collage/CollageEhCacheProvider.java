...
/**
 * WARNING: this implementation should be upgraded when upgrading Hibernate or EhCache
 *
 ...
 * @author Emmanuel Bernard
 */
public class CollageEhCacheProvider implements CacheProvider {

    private static final Log log = LogFactory.getLog(CollageEhCacheProvider.class);
