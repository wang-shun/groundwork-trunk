...
public class ActionProperty implements com.groundwork.collage.model.ActionProperty 
{
	private Integer actionPropertyId = null;
	...
	public void setActionPropertyId(Integer actionParameterId) {
		this.actionPropertyId = actionParameterId;
	}
	...
	public String toString()
    {
        return new ToStringBuilder(this)
                .append("actionPropertyId", getActionPropertyId()).toString();
    }

    /** 
     * two ActionProperty objects are equal if they have the same action and name, 
