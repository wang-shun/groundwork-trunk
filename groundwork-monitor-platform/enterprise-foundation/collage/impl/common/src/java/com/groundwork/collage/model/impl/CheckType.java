...
public class CheckType extends PropertyExtensibleAbstract implements Serializable,
        com.groundwork.collage.model.CheckType
{
    ...
    /** full constructor */
    public CheckType(Integer checkTypeId, String name, String description)
    {
    ...
    /** minimal constructor */
    public CheckType(Integer checkTypeId)
    {
        this.checkTypeId = checkTypeId;
    }
    ...
    /**
     * Two CheckTypes are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        if ( (this == other ) ) return true;
        if ( !(other instanceof CheckType) ) return false;
        CheckType castOther = (CheckType) other;
        return new EqualsBuilder()
            .append(this.getCheckTypeId(), castOther.getCheckTypeId())
	...
	{
		return new EntityPropertyValue(checkTypeId, getEntityTypeId(), name, value);
	}
