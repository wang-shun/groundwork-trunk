...
public class Component extends PropertyExtensibleAbstract implements Serializable,
        com.groundwork.collage.model.Component
{
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("Id", getComponentId())
            .append("value", getName())
            .toString();
    }

    /**
     * Two Components are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        ...
        return new EqualsBuilder()
            .append(this.getComponentId(), castOther.getComponentId())
	...
	{
		return new EntityPropertyValue(componentId, getEntityTypeId(), name, value);
	}
