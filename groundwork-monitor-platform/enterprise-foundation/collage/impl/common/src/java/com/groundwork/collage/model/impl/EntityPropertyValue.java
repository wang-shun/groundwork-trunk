...
public class EntityPropertyValue extends PropertyValue implements Serializable, com.groundwork.collage.model.EntityPropertyValue
{
	...
	public EntityPropertyValue(Integer objectId, Integer entityTypeId, String name, Object value)
	{
		super(name, value);
     ...
     * compared in a case-insensitive way and related to the same owner id and type
     */
    public boolean equals(Object other) {
        if ( (this == other ) ) return true;
        if ( !(other instanceof ServiceStatus) ) return false;
        EntityPropertyValue castOther = (EntityPropertyValue) other;
