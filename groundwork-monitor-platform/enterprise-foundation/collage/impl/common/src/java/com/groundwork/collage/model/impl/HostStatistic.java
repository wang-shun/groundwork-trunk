...
public class HostStatistic extends StatisticEntity implements Serializable, PropertyExtensible
{
    ...
    /** the name that identifies this entity in the system: "HOST_STATISTICS" */
    public static final String ENTITY_TYPE_CODE = "HOST_STATISTICS";
	 ...
	 * @param statProperty
	 */
	public HostStatistic (String hostGroupName, StatisticProperty statProperty)
	{
	...
	public List<PropertyType> getBuiltInProperties() 
	{
		...
		BUILT_IN_PROPERTIES.add(PROP_HOSTGROUP_NAME);
	...
	public Object getProperty(String propertyName) 
	{
    	...
    	else if (propertyName.equalsIgnoreCase(PROP_HOSTGROUP_NAME.getName()))
    	{
