...
public class LogMessagePropertyValue extends PropertyValue implements Serializable, com.groundwork.collage.model.LogMessagePropertyValue
{
    ...
    /** default constructor */
    public LogMessagePropertyValue()
    {
    }

	public LogMessagePropertyValue(Integer logMessageId, String name, Object value)
	{
		super(name, value);
    ...
    public boolean equals(Object other) {
        ...
        LogMessagePropertyValue castOther = (LogMessagePropertyValue) other;

        return new EqualsBuilder()
            .append(this.getLogMessageId(), castOther.getLogMessageId())
