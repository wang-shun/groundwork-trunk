...
public class MonitorStatus extends PropertyExtensibleAbstract implements Serializable, com.groundwork.collage.model.MonitorStatus
{
    ...
    /** full constructor */
    public MonitorStatus(Integer monitorStatusId, String name,
            String description)
    {
    ...
    /** minimal constructor */
    public MonitorStatus(Integer monitorStatusId)
    {
        this.monitorStatusId = monitorStatusId;
    }
    ...
    public String toString()
    {
        return new ToStringBuilder(this)
            .append("monitorStatusId", getMonitorStatusId())
    ...
    /**
     * Two MonitorStatuses are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        if ( (this == other ) ) return true;
        if ( !(other instanceof MonitorStatus) ) return false;
        MonitorStatus castOther = (MonitorStatus) other;
        return new EqualsBuilder()
            .append(this.getMonitorStatusId(), castOther.getMonitorStatusId())
	...
	{
		return new EntityPropertyValue(monitorStatusId, getEntityTypeId(), name, value);
	}
