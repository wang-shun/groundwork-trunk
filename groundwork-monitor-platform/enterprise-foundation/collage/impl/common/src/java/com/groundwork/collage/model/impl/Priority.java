...
public class Priority extends PropertyExtensibleAbstract implements Serializable, com.groundwork.collage.model.Priority
{
    ...
    /** full constructor */
    public Priority(Integer priorityId, String name, String description)
    {
    ...
    /**
     * Two Prioritys are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        if ( (this == other ) ) return true;
        if ( !(other instanceof Priority) ) return false;
        Priority castOther = (Priority) other;
        return new EqualsBuilder()
            .append(this.getPriorityId(), castOther.getPriorityId())
	...
	{
		return new EntityPropertyValue(priorityId, getEntityTypeId(), name, value);
	}
