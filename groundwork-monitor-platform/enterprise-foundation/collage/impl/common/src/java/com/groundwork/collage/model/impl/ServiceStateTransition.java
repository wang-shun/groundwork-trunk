...
public class ServiceStateTransition extends StateTransition 
{
    ...
    /** the name that identifies this entity in the system: "SERVICE_STATE_TRANSITIONS" */
    public static final String ENTITY_TYPE_CODE = "SERVICE_STATE_TRANSITIONS";
	...
	public static final PropertyType PROP_SERVICE_NAME = 
		new com.groundwork.collage.model.impl.PropertyType(				
								"ServiceDescription",
								"ServiceDescription",
								PropertyType.DataType.STRING, 
	 ...
	 * @param statProperty
	 */
	public ServiceStateTransition (String hostName, 
	...
	public List<PropertyType> getBuiltInProperties() 
	{
		...
		BUILT_IN_PROPERTIES.add(PROP_SERVICE_NAME);
	...
	public Object getProperty(String propertyName) 
	{
		...
		else if (propertyName.equalsIgnoreCase(PROP_SERVICE_NAME.getName()))
    	{
