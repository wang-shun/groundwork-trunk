...
public class StateType extends PropertyExtensibleAbstract implements Serializable, com.groundwork.collage.model.StateType
{
    ...
    /** full constructor */
    public StateType(Integer stateTypeId, String name, String description) {
    ...
    /** minimal constructor */
    public StateType(Integer stateTypeId) {
        this.stateTypeId = stateTypeId;
    }
    ...
    /**
     * Two StateTypes are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        if ( (this == other ) ) return true;
        if ( !(other instanceof StateType) ) return false;
        StateType castOther = (StateType) other;
        return new EqualsBuilder()
            .append(this.getStateTypeId(), castOther.getStateTypeId())
	...
	{
		return new EntityPropertyValue(stateTypeId, getEntityTypeId(), name, value);
	}
