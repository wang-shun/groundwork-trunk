...
public class TypeRule extends PropertyExtensibleAbstract implements Serializable, com.groundwork.collage.model.TypeRule {
    ...
    /** full constructor */
    public TypeRule(Integer typeRuleId, String name, String description)
    {
    ...
    /** minimal constructor */
    public TypeRule(Integer typeRuleId, String name)
    {
        this.typeRuleId = typeRuleId;
        this.name = name;
    }

    public Integer getTypeRuleId() {
        return this.typeRuleId;
    }

    public void setTypeRuleId(Integer typeRuleId) {
        this.typeRuleId = typeRuleId;
    }

    public Integer getID ()
	{
		return getTypeRuleId();
	}  
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("Id", getTypeRuleId())
            .append("value", getName())
            .toString();
    }

    /**
     * Two TypeRules are equal if they share the same name and numeric Id 
     */
    public boolean equals(Object other) 
    {
        if ( (this == other ) ) return true;
        if ( !(other instanceof TypeRule) ) return false;
        TypeRule castOther = (TypeRule) other;
        return new EqualsBuilder()
            .append(this.getTypeRuleId(), castOther.getTypeRuleId())
	...
	{
		return new EntityPropertyValue(typeRuleId, getEntityTypeId(), name, value);
	}
