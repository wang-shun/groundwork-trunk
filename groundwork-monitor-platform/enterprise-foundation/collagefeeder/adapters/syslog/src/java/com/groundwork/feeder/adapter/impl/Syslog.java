...
public class Syslog implements FeederBase {
	...
	public void process(Object beanFactory, FoundationMessage message)
	{
    	if (message == null)
    	{
    		System.out.println("SYSLOG Adapter: Null FoundationMessage.");
    		return;
    	}
        ...
        {
            System.out.println("SYSLOG Adapter: Could not find attributes in xml " + message);
        ...
        {
            throw new CollageException("Error in Syslog Adapter. One or more required properties are missing. Make sure to specify: MonitorServerName, Device and Severity in your request. Current request [" + message + "]");
        }
        ...
        if (property == null)
        	...
        	props.setProperty( LogMessage.EP_HOST_NAME,  property);
        ...
        if (property == null)
        	...
        	props.setProperty( LogMessage.EP_LAST_INSERT_DATE, property);
        
        /*Optional*/
        property = (String)attributes.get(this.FIRST_INSERT_DATE);
        if (property != null)
        	props.setProperty( LogMessage.EP_FIRST_INSERT_DATE, property);
        ...
        // Adding text message.JIRA 5634
        property = (String)attributes.get(this.TEXT_MESSGE);
        if (property == null)
        	throw new CollageException("Error in Syslog Adapter. Property TextMessage is missing. Make sure to specify a valid value for the property.");
        else
        	props.setProperty( "TextMessage", property);
