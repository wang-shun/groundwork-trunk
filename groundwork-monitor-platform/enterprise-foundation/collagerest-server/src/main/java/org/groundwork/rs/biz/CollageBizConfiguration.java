...
public class CollageBizConfiguration implements ConfigurationWatcherNotificationListener {

    private static Log log = LogFactory.getLog(CollageBizConfiguration.class);

    public static final String SOLAR_WIND_CONFIG_FILE = "/usr/local/groundwork/config/collage-biz.properties";
    ...
    private static CollageBizConfiguration singleton = null;
    private Properties configuration = null;
    private String watchedFileName = null;

    // Public Static Interface
    public synchronized static final CollageBizConfiguration instance() {
        if (singleton == null) {
            singleton = new CollageBizConfiguration();
            singleton.initConfiguration();
        }
        return singleton;
    }

    private CollageBizConfiguration() {
    }
...
//        App_Type_Entities = LOG_MESSAGE, HOST_STATUS
    ...
    public String translateStatus(String propertyName) {
        ...
        return (gwStatus == null) ? "UNKNOWN" /*MonitorStatus.UNKNOWN.name()*/ : gwStatus;
    }
