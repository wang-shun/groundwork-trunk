...
public class ExtendedUIRole implements Serializable {
    ...
    public ExtendedUIRolePermissionList getRolePermissions() {
        return rolePermissions;
    }

    public void setRolePermissions(ExtendedUIRolePermissionList rolePermissions) {
        this.rolePermissions = rolePermissions;
    }

    private ExtendedUIRolePermissionList rolePermissions = null;
