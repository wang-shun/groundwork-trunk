...
public class Base58Codec {
	...
	public static byte[] doDecode(final String source) {
		...
		while (it.hasNext()) {
			value = value.add(BigInteger.valueOf(indexOf(ALPHABET, it.next())));
			if (it.hasNext())
    ...
    /**
     * Adapted from commons-lang3-3.2 org.apache.commons.lang3.ArrayUtils.indexOf(char[],char).
     *
     * @param array array to index
     * @param valueToFind value to index
