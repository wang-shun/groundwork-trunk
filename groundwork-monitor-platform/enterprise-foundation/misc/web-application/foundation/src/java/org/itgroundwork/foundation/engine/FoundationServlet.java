	...
	public final void init(ServletConfig config) throws ServletException {
		...
		synchronized (this.getClass()) {
			...
			try {
				...
				// Start the vema perfData service here. Constructor argument should match the type in the perfdata.properties file. For ex, VEMA
				// Schedulet to run every 30 secs
				vemaPerfDataService = new PerfDataService("perfdata.vema.jms.queue.name", 30);
