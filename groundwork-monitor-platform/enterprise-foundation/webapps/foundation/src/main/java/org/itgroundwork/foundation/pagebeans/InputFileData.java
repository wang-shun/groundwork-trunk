...
public class InputFileData {
    ...
    public String getSizeFormatted() {
        ...
        if (ourLength >= PluginBean.MEGABYTE_LENGTH_BYTES) {
            return ourLength / PluginBean.MEGABYTE_LENGTH_BYTES + " MB";
        }
        else if (ourLength >= PluginBean.KILOBYTE_LENGTH_BYTES) {
            return ourLength / PluginBean.KILOBYTE_LENGTH_BYTES + " KB";
        }
        else if (ourLength == 0) {
            return "0";
        }
