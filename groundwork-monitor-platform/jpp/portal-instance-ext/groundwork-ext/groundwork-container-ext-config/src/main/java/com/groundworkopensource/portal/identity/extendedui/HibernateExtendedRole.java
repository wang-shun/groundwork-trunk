...
public class HibernateExtendedRole  {
    ...
    public Set<HibernateExtendedRolePermission> getRolePermissions() {
        return rolePermissions;
    }

    public void setRolePermissions(Set<HibernateExtendedRolePermission> rolePermissions) {
        this.rolePermissions = rolePermissions;
    }

    private Set<HibernateExtendedRolePermission> rolePermissions = new HashSet<HibernateExtendedRolePermission>(0);;
