...
public class CategoryEditorPortlet extends GroundworkDashboardPortlet {
    ...
    protected void doHeaders(RenderRequest request, RenderResponse response) {
        ...
        // Temporary workaround until we can figure out collision with JBoss menus
        addJavaScript(response, request.getContextPath() + "/app/scripts/d3/d3.min.js", "gwmd_d3");
    }
    ...
    protected void doEdit(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        if (authenticate(request, response)) {
            ...
            String url = request.getPreferences().getValue(PREFS_EDIT, "/app/views/categories-edit.jsp" );
