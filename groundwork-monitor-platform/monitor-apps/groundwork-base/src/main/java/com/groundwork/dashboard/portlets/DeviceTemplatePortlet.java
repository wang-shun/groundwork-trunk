...
public class DeviceTemplatePortlet extends GroundworkDashboardPortlet {

    protected static Log log = LogFactory.getLog(DeviceTemplatePortlet.class);
    ...
    protected void doEdit(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        if (authenticate(request, response)) {
            ...
            String url = request.getPreferences().getValue(PREFS_EDIT, "/app/views/device-template-edit.jsp" );
