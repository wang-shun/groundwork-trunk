...
public class VmWareEnvironmentPortlet extends GroundworkDashboardPortlet {

    protected static Log log = LogFactory.getLog(VmWareEnvironmentPortlet.class);
    ...
    protected void doEdit(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        if (authenticate(request, response)) {
            ...
            String url = request.getPreferences().getValue(PREFS_EDIT, "/app/views/monitor-edit.jsp" );
