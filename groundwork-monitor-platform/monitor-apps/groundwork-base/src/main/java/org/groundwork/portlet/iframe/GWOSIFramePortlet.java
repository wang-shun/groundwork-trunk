...
public class GWOSIFramePortlet extends IFramePortlet {
	...
	protected static final String PARAM_UID = "ATTACH_UID";
    ...
    /**
     * Get attach UID configuration; by default read from portlet init parameter.
     *
     * @param config portlet configuration
     * @return attach UID
     */
    protected boolean getIsAttachUID(PortletConfig config) {
        return Boolean.parseBoolean(config.getInitParameter(PARAM_UID));
    }
	...
	public void init(PortletConfig config) throws PortletException {
		...
		// throw an exception
		configuredURL = getIFrameSource(config);
        ...
        // Set attach UID
        this.isAttachUID = getIsAttachUID(config);
