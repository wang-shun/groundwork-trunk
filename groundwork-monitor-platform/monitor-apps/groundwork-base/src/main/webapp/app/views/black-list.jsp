...
<div class="panel panel-default no-border " ng-controller="BlackListController" ng-init="init('<%=renderResponse.encodeURL(readPrefs.toString())%>')">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 no-padding">
            <div class="form-group">
                <div class="col-sm-6 col-md-6 col-lg-6 no-padding">
                    <input type="text" class="form-control" id="host-identities-search" placeholder="Filter Hosts" ng-model="filters.hostname" ng-keyup="checkAddHost($event)" />
                </div>
                &nbsp;&nbsp;
