...
<div class="panel panel-primary">
    <div class="panel-heading">Events Preferences</div>
        ...
        <form name="topForm" class="form-horizontal app-form" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class='errorMessage' ng-show="topForm.rows.$dirty && topForm.rows.$error.required">Enter number of rows 1..20</div>
                </div>
            </div>
            ...
            <span ng-show="topForm.rows.$error.pattern">Not a valid number. Range is 1..20</span>
