...
<div id="actionWithoutPost"><a href="<%= actionTwoUrl %>">Save Test</a></div>

<div class="panel panel-primary">
    <div class="panel-heading">Unhandled Hosts and Services</div>
    <div ng-controller="NocBoardEditController" class='panel-body'
        ...
        <form name="nocboardForm" class="form-horizontal app-form" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="errorMessage" ng-show="nocboardForm.rows.$dirty && nocboardForm.rows.$invalid">Enter number of rows 1..30</div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="errorMessage" ng-show="nocboardForm.refreshSeconds.$dirty && nocboardForm.refreshSeconds.$invalid">Enter Refresh Rate in seconds 0..3600</div>
                </div>
            </div>
            ...
            <button  class="btn btn-primary" ng-click="update(prefs)" ng-disabled="nocboardForm.$invalid || isUnchanged(prefs)" tabindex='6'>Submit</button>
            <span class="errorMessage" ng-show="nocboardForm.rows.$error.pattern">Not a valid number. Range is 1..20</span>
            <span class="errorMessage" ng-show="nocboardForm.refreshSeconds.$error.pattern">Not a valid number for  Refresh Rate in seconds</span>
