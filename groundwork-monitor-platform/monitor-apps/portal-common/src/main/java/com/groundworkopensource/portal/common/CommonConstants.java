...
public class CommonConstants {
    ...
    public static final String FOUNDATION_REST_MOUNT_POINT = "foundation_rest_url";
     ...
     * GWOS TOKEN
     */
    public static final String GWOS_API_TOKEN = "GWOS-API-TOKEN";

    /**
     * GWOS APP NAME
     */
    public static final String GWOS_APP_NAME = "GWOS-APP-NAME";
