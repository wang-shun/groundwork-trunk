...
public class FacesUtils {
    ...
    public static final String APP_NAME_GWOS_ENTERPRISE = "GWOS_ENTERPRISE";
     ...
     *
     * @param faceContext the facesContext to set
     */
    ...
    /**
     * Helper method to get the extended roles
     * @param user
     * @return
     * @throws Exception
     */
    public static ExtendedRoleList getExtendedRoles(String user)
            throws Exception {
        ExtendedRoleClient client = new ExtendedRoleClient(WebServiceLocator.getInstance().portalExtnRESTeasyURL(),MediaType.APPLICATION_XML_TYPE);
        return client.findRolesByUser(user);
    }
