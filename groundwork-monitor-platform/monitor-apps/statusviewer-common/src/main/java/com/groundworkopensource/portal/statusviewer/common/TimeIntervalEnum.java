...
public enum TimeIntervalEnum {
     ...
     * @param label
     */
    private TimeIntervalEnum(String value, String label, boolean isHours,
            int valueToAdd) {
        this.value = value;
        this.label = label;
        this.isHours = isHours;
     ...
     * Logger
     */
    private static Logger logger = Logger.getLogger(TimeIntervalEnum.class
            .getName());

    /**
     * Map for retrieving parent menu status.
     */
    private static Map<String, TimeIntervalEnum> timeIntervalMap;
    // statically initialize entity-status map.
    static {
        timeIntervalMap = new HashMap<String, TimeIntervalEnum>() {
            /**
             * Serial Id
             */
            ...
            {
                TimeIntervalEnum[] timeIntervalArray = TimeIntervalEnum
                        .values();
                for (TimeIntervalEnum timeInterval : timeIntervalArray) {
     ...
     * @return parentMenu
     */
    public static TimeIntervalEnum getTimeIntervalEnum(String value) {
        TimeIntervalEnum timeIntervalEnum = timeIntervalMap.get(value);
