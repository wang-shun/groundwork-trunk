...
/**
 * This portlet displays the performance monitoring graphs and statistic
 * 
 * @author mridu_narang
 * 
 */

public class MonitoringPerformancePortlet extends BasePortlet {

    /**
     * Title of portlet
     */
    public static final String MONITORING_PERFORMANCE_TITLE = "Monitoring Performance";
    ...
    protected void doView(RenderRequest request, RenderResponse response)
            throws PortletException, IOException {
        super.setViewPath(Constant.MONITOR_PERFORMANCE_VIEW_PATH);

        // Set the portlet title.
        response.setTitle(PortletUtils.getPortletTitle(request,
                MONITORING_PERFORMANCE_TITLE));
