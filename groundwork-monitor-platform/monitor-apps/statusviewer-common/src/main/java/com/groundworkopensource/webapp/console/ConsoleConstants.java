...
public interface ConsoleConstants {
    ...
    String MANAGED_BEAN_FILTER = "consoleFilterBean";
    ...
    /** The MANAGE d_ bea n__ popup. */
    String MANAGED_BEAN_ACTION = "consoleActionBean";
    ...
    /** The FILTE r_ device. */
    String FILTER_DEVICE_HOST = "device.hosts.hostName";

    /** The FILTE r_ device. */
    String FILTER_HOST = "hostName";

    /** filter for device ip address */
    String FILTER_ADDRESS = "device.identification";
    ...
    /** The MO n_ statu s_ scheduled. */
    String MON_STATUS_SCHEDULED = "scheduled";

    /** The MO n_ statu s_ unscheduled. */
    String MON_STATUS_UNSCHEDULED = "unscheduled";
    ...
    public static final String NAGIOS_ACK_COMMENTS = "AcknowledgeComment";
    /**
     * COMMA
     */
    ...
    /**
     * Host Group no bubble up path.
     */
    public static final String HOST_GROUP_NO_STATUS = "/images/selection.png";
    ...
    /**
     * Service Group no bubble up path.
     */
    public static final String SERVICE_GROUP_NO_STATUS = "/images/selection.png";
    ...
    /**
     * Custom Group no bubble up path.
     */
    public static final String CUSTOM_GROUP_NO_STATUS = "/images/selection.png";
    ...
    public static final String ACKNOWLEDGE_LOG_MESSAGE = "Acknowledge Log Message";
     ...
     */
    public static final String TOPIC_FOUNDATION_EVENTS = "/topic/foundation_events";
