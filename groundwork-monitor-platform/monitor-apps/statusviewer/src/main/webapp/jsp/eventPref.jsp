...
<table border="0">
	...
	<tr id="nodeNameRow" style="display:table-row">
		<td>Enter Name :</td>
		<td>
			<input type="text" name="gw_nodeName" id="gw_nodeName" class="nodeName_ELP" value="<%=renderRequest.getAttribute("gw_nodeName")%>" />
		</td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name='eventsPerPage' id='eventsPerPage'
			value='<%=renderRequest.getAttribute("eventsPerPage")%>' /></td>
	</tr>
	
	<tr>
		<td>Enter Custom Portlet Title :</td>
		<td><input type="text" name='customPortletTitle' id='customPortletTitle'
