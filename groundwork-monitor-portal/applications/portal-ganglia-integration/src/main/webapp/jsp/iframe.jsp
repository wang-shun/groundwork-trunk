...
<table id="enclosure" width="<%= request.getAttribute("iframewidth") %>" cellpadding=0 cellspacing=0 border=0>
...
<%}%>
	...
	<td>
	    ...
	    document.write('<iframe id="myframe" src="<%= request.getAttribute("iframeurl") %>" width="100%"' +
	...
	<%} else {%>
	    <iframe src="<%= request.getAttribute("iframeurl") %>" width="<%= request.getAttribute("iframewidth") %>"
