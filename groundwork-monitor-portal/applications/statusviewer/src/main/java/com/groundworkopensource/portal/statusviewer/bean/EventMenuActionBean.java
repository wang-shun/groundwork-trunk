...
import com.groundworkopensource.portal.statusviewer.handler.EventQueryManager;
...
public class EventMenuActionBean implements Serializable {
    ...
    /**
     * DEFAULT_TOPIC_NAME - to be published for Event topic
     */
     ...
     * @param actionFired
     */
    private void actionPerformOnRow(int actionFired) {
        ...
        if (selectedEvents != null && selectedEvents.length > 0) {
            ...
            EventActionHandler eventActionHandler = new EventActionHandler();
    ...
    public void menuPopUpListener(ActionEvent actionEvent) {
        ...
        if (actionId != null) {
            actionPerformOnRow(actionId.intValue());
        } else {
