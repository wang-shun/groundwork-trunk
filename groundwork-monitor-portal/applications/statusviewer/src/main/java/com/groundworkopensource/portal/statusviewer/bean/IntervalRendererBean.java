 ...
 * 
 */
public class IntervalRendererBean implements Renderable, Serializable {
     ...
     * logger
     */
    private static Logger logger = Logger.getLogger(IntervalRendererBean.class
            .getName());
     ...
     * @param intervalInSec
     */
    public IntervalRendererBean(long intervalInSec) {
        if (intervalInSec == 0) {
