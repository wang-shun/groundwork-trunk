...
public class SeuratBean {
    ...
    public SeuratBean(int objectId, String name, SeuratStatusEnum status,
            long lastStateChange, NodeType nodeType, String hostGroupName, boolean acknowledged, List<Integer> childList, ReferenceTreeMetaModel referenceTree) {
        super();
     ...
     * @param hostGroupName
     */
    public SeuratBean(int objectId, String name,
            SeuratStatusEnum seuratStatusEnum, boolean isAcknowledged,
