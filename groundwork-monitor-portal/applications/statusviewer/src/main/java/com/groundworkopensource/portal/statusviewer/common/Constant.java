...
public class Constant {
    ...
    */
     ...
     */
    public static final String EVENT_COLUMN_STRING = "reportDate:Received By GW,msgCount:Msg Count,device:Device,statusBean:Status,textMessage:Message,applicationType:Application Type,severity:Severity,lastInsertDate:Last Detected,firstInsertDate:First Detected";
     ...
     */
    public static final String DIV_TAG_VISIBLE_STYLE_FOR_HOST_AVAIL = "height: 180px; border: none; overflow-x:hidden;overflow-y:auto;";
     ...
     */
    public static final String NODE_NAME_PREF = "nodeName";
    ...
    /**
     * String constant for USer Role : 'GWAdmin'
     */
    public static final String USER_ROLE_ADMIN = "GWAdmin";

    /**
     * String constant for USer Role : 'GWOperator'
     */
    public static final String USER_ROLE_OPERATOR = "GWOperator";
