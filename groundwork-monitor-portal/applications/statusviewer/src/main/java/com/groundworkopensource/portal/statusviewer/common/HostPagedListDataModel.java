 ...
 */
public abstract class HostPagedListDataModel extends DataModel {
     ...
     * data page
     */
    protected HostListDataPage page;

    /**
     * Logger
     */
    private static final Logger LOGGER = Logger
            .getLogger(HostPagedListDataModel.class.getName());
     ...
     * @param pageSize
     */
    public HostPagedListDataModel(int pageSize) {
        super();
     ...
     */
    private HostListDataPage getPage() {
        if (page != null) {
            return page;
        }
     ...
     * @return DataPage
     */
    public abstract HostListDataPage fetchPage(int startRow, int pageSize);

    /**
     * @param page
     */
    public void setPage(HostListDataPage page) {
        this.page = page;
    }
