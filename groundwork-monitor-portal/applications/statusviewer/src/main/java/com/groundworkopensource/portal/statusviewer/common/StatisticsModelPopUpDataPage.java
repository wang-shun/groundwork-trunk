 ...
 */
public class StatisticsModelPopUpDataPage {
    /**
     ...
     */
    private final List<ModelPopUpDataBean> data;
     ...
     */
    public StatisticsModelPopUpDataPage(int datasetSize, int startRow,
            List<ModelPopUpDataBean> data) {
     ...
     * @return int
     */
    public List<ModelPopUpDataBean> getData() {
        return data;
    }
}
