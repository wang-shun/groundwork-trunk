...
public class InformationPortletsHandler extends ServerPush implements
    ...
    private void setHostInformationPortletDetails() {
     ...
     // One way of differentiating NAGIOS apptype and VEMA
        ...
        Object comments = host.getPropertyTypeBinding().getPropertyValue("Comments");
        if (comments != null)
        	hostInformationBean.setApplicationType(Constant.NAGIOS);
        else
        	hostInformationBean.setApplicationType(Constant.VEMA);
    ...
    private void setServiceInformationPortletDetails() {
        ...
        // One way of differentiating NAGIOS apptype and VEMA
        Object comments = service.getHost().getPropertyTypeBinding().getPropertyValue("Comments");
        if (comments != null)
        	serviceInformationBean.setApplicationType(Constant.NAGIOS);
        else
        	serviceInformationBean.setApplicationType(Constant.VEMA);
