...
<table border="0">
	<tr>
		<td>Enter ServiceGroup Name :</td>
		<td><input type="text" name='serviceGroupPref' id='serviceGroupPref'
			value='<%=renderRequest.getAttribute("serviceGroupPref")%>' /></td>
	</tr>
...
jQuery(document).ready(function() {
	var data = "<%= referenceTree.getAllServiceGroupNameList() %>".split(",");
	jQuery("#serviceGroupPref").autocomplete(data);
  });
 </script>