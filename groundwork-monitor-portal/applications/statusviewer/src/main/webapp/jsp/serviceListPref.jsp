...
<table border="0">
	<tr>
		<td>Select Entity :</td>
		<td>
			<input type="radio" name="nodeType" id="radioEntireNetwork_SLP" class="radioEntireNetwork_SLP" value="Network" onclick="document.getElementById('nodeName').disabled=true;" /> Entire Network 
	...
	<tr>
		<td>Enter Name :</td>
		<td>
			<input type="text" name="nodeName" id="nodeName" class="nodeName_SLP" value="<%=renderRequest.getAttribute("nodeName")%>" />
		</td>
	</tr>
	<tr>
		<td>
