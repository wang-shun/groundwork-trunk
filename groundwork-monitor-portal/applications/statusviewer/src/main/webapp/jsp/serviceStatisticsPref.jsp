...
<table border="0">
	<tr>
		<td>Select Entity :</td>
		<td>
			<input type="radio" name="nodeType" id="radioEntireNetwork" class="radioEntireNetwork" value="Network" checked="checked"  onclick="getElementById('nodeName').disabled=true;" /> EntireNetwork 
	...
	<tr>
		<td>Enter Name :</td>
		<td>
			<input type="text" name="nodeName" id="nodeName" value="<%=renderRequest.getAttribute("nodeName")%>" />
		</td>
	</tr>
	<tr>
