...
public class CommonWSFacadeTest extends TestCase {
    ...
    /**
     * Test method for
     * {@link com.groundworkopensource.portal.common.ws.impl.CommonWSFacade#searchEntity(java.lang.String, int)}
     * .
     */
    public void testSearchEntity() {
        ...
        try {
            resultCollection = foundationWSFacade.searchEntity("localhost",
                    FIFTY);
