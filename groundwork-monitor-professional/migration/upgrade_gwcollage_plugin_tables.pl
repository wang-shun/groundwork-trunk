...
# upgrade_gwcollage_plugin_tables.pl
...
# GDMA 2.2.2 release, before this upgrade_gwcollage_plugin_tables.pl
# script is run.  That will ensure that the plugin support tables exist
# and have the correct structure for this script to operate.
