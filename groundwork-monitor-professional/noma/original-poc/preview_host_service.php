...
switch ($p['entity']) {
	case 'r':       $column = 'name';
                                $monarch_table = 'contacts';
                                break;
        case 'sg':      $column = 'name';
                                $monarch_table = 'servicegroups';
                                break;
	case 'hg':	$column = 'name';
				$monarch_table = 'hostgroups';
				break;
	case 'h':	$column = 'name';
				$monarch_table = 'hosts';
				break;
	case 's':	$column = 'name';
				$monarch_table = 'services as s,service_names as sn';
				$where_clause = 'and s.servicename_id = sn.servicename_id';
				break;
