...
use constant PLUGIN => 'check_windows';
...
# NOTE: Windows returns the local time for whatever timezone the server is     #
#       in without providing a timezone offset from GMT as they should.        #
################################################################################
sub clock {
...
################################################################################
# proc - check for system processes using HOST-RESOURCE-MIB                    #
################################################################################
sub processes {
