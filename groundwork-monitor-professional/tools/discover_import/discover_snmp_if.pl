...
#-----------------------------------------------------------------------------
#    This script is used to generate a CVS file containing a list of interfaces
#   on a router or switch. The snmpwalk command is used to query each host in
#   the array @hostipaddress. The output file "discover_snmp.out" can be used
#   by the GroundWork Import Tool to assign the data gathered to a Host
#   Profile.
#-----------------------------------------------------------------------------
use strict;
#-----------------------------------------------------------------------------
...
my $CSVIMPORT = "$GW_HOME/tools/discover_import";
