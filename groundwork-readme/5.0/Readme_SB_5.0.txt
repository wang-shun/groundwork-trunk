Readme rev 1.1	Current Release: GroundWork Monitor Small Business 5.0.2
...
Host Wizard: The template override values from a host profile are not applied. The workaround is to 
apply the detail to the host(s) from the host profile after the host has been added.
		
© GroundWork Open Source, Inc.		Page 1 of 5
