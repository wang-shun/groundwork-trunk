...
# TO DO:
# (*) Some parts of this script and the GWIR.pm library it calls invoke die(),
#     but the exception processing and i/o handling is not yet set up to capture
#     such error data and reflect it to the screen where it would be noticeable.
...
# For possible use in debugging customer issues.
if (0) {
    ## If requested (only), we re-open the STDERR stream as a duplicate of the
    ## STDOUT stream, to capture any output written to STDERR (from, say, any
	...
	## It turns out that once the redirect happens, what matters is that we
	## autoflush the endpoint file descriptor, not the startpoint descriptor.
	## But of course, this imposes a possible performance degradation.
	STDOUT->autoflush(1);
	# STDERR->autoflush(1);
    }
}
...
print "<FORM action=nagios_alarms1.pl method=get>";
print "<table class='data' border='0' cellpadding='5' cellspacing='2' width='100%'>
    <TBODY><tr class='tableHeaderPage'>
";
print "<td>Alerts Report &mdash; $thisday, $month $mday, $year at $timestring</td></tr>";
...
my $help_url = StorProc->doc_section_url('Insight+Reports', 'InsightReports-AlertReports');
...
<TR>
    <TD class=tableFill03><span class='header'>Show Top Alarms by:</span>
	&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=checkbox value=1 " . $checked{ $FORM_DATA{showtophostgroups} } . " name=showtophostgroups>&thinsp;Host Group
	&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=checkbox value=1 " . $checked{ $FORM_DATA{showtophosts} } . " name=showtophosts>&thinsp;Host
	&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=checkbox value=1 " . $checked{ $FORM_DATA{showtophostservices} } . " name=showtophostservices>&thinsp;Host-Service
	&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=checkbox value=1 " . $checked{ $FORM_DATA{showtopservices} } . " name=showtopservices>&thinsp;Service
	</TD>
	</TR>
	<TR>
	<TD class=tableFillNone>
	<INPUT type=submit class=button value='Generate Report' name=submit>&nbsp;
	<a STYLE='text-decoration:none' href=nagios_alarms1.pl><INPUT type=reset class=button value='Reset'></a>&nbsp;
...
if ( $FORM_DATA{showchart} ) {
    ## print "<h4>Showing alarm trend chart.</h4>";
    print_alarm_trend_chart();
}
if ( $FORM_DATA{showdetail} ) {
    ## print "<h4>Showing detail.</h4>";
    print_detail_table();
}
...
if ( $FORM_DATA{showtophostgroups} ) {
    ...
    print "<td colspan=2>Top Alarms by Host Group</td>";
    my $printstring = print_top_components( "nagios alerts", $component );
    ## print "<tr><td class=tableFill03  style='border: 0px none ;'> ";
	...
	print_trend_chart_component( "nagios alerts", $component );
	print "<tbody><tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>
	    ...
	    <IMG border=0 src='$graphhtmlref/$graphfile?$time' alt='Top Alarms by Host Group' hspace='20'></td></tr>";
	...
	print "<td class=tableFill01  valign='top' width='57' align=center>Alarms</td></tr>";
	print $printstring;
	print "<tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>";
	print "</tbody>";
    }
...
if ( $FORM_DATA{showtophosts} ) {
    ...
    print "<table class='data' border='0' cellpadding='5' cellspacing='1' width='100%'><colgroup width='45%'></colgroup><colgroup width='*'></colgroup>";
    print "<tbody><tr class='tableHeader'>";
    print "<td colspan=2>Top Alarms by Host</td>";
    my $printstring = print_top_components( "nagios alerts", $component );
    print "<tr><td class=tableFill03> ";
    print "<table cellpadding='5' cellspacing='1' >";
    if ($printstring) {
	...
	print "<tbody><tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>
	    <tr><td style='border: 0px none ;' valign='top'>
	    <IMG border=0 src='$graphhtmlref/$graphfile?$time' alt='Top Alarms by Host' hspace='20'></td></tr>";
	print "<tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>";
	print "</tbody>";
	print "</table>";
	print "</td>";
...
if ( $FORM_DATA{showtophostservices} ) {
    ...
    print "<table class='data' border='0' cellpadding='5' cellspacing='1' width='100%'><colgroup width='45%'></colgroup><colgroup width='*'></colgroup>";
    print "<tbody><tr class='tableHeader'>";
    print "<td colspan=2>Top Alarms by Host and Service</td>";
    my $printstring = print_top_components( "nagios alerts", $component );
    print "<tr><td class=tableFill03> ";
    print "<table cellpadding='5' cellspacing='1' >";
    if ($printstring) {
	...
	print "<tbody><tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>
	    <tr><td style='border: 0px none ;' valign='top'>
	    <IMG border=0 src='$graphhtmlref/$graphfile?$time' alt='Top Alarms by Host and Service' hspace='20'></td></tr>";
	print "<tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>";
	print "</tbody>";
	print "</table>";
	print "</td>";
...
if ( $FORM_DATA{showtopservices} ) {
    ...
    print "<table class='data' border='0' cellpadding='5' cellspacing='1' width='100%'><colgroup width='45%'></colgroup><colgroup width='*'></colgroup>";
    print "<tbody><tr class='tableHeader'>";
    print "<td colspan=2>Top Alarms by Service</td>";
    my $printstring = print_top_components( "nagios alerts", $component );
    print "<tr><td class=tableFill03> ";
    print "<table cellpadding='5' cellspacing='1' >";
    if ($printstring) {
	...
	print "<tbody><tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>
	    <tr><td style='border: 0px none ;' valign='top'>
	    <IMG border=0 src='$graphhtmlref/$graphfile?$time' alt='Top Alarms by Service' hspace='20'></td></tr>";
	print "<tr><td style='border: 0px none ;'><img border=0 src='$graphhtmlref/images/spacer.gif' alt='' height='1' width='1'></td></tr>";
	print "</tbody>";
	print "</table>";
	print "</td>";
